...
import { getCoreSections, getRequiredChefCount, getAdjustedGtTargetsByChef, isUnavailable } from './validation.js?v=20260719s';
import { isSenior } from './scoring.js?v=20260719s';
import { getGtChefNamesForDay, hasGtAssignment } from './rota-model.js?v=20260719s';

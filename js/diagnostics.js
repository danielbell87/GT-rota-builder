...
import { getCoreSections, getRequiredChefCount, getAdjustedGtTargetsByChef, isUnavailable } from './validation.js?v=20260719o';
import { isSenior } from './scoring.js?v=20260719o';
import { getGtChefNamesForDay, hasGtAssignment } from './rota-model.js?v=20260719o';
